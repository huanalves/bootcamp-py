...
while True:
    ...
    if not nome.isdigit(): #checa se valor inserido é apenas número ou string contendo número
        continue
    elif nome.isalpha(): #checa se valor inserido é um string contendo número (alphanúmerico)
        print("Nome inserido inválido")
        continue
    elif nome.isspace(): #checa se valor inserido é apenas espaço
        print("Insira um texto válido")
        continue
    elif nome.strip(): #checa se valor inserido não contém carácter
